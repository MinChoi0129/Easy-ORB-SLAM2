...
Viewer::Viewer(System *pSystem, FrameDrawer *pFrameDrawer,
    ...
    : mpSystem(pSystem), mpFrameDrawer(pFrameDrawer), mpMapDrawer(pMapDrawer),
      ...
      mbStopped(true), mbStopRequested(false), mbReuseMap(mbReuseMap_) {
...
void Viewer::Run() {
  ...
  bool bFollow = true;
  // bool bLocalizationMode = false; // original code

  // bLocalizationMode �ʱⰪ�� ������ ���������� ����
  // mbReuseMap���� ���� ���۵Ǵ� ��尡 �ٸ���. [LOCALIZATION | SLAM MODE]
  ...
  while (1) {
    ...
    if (menuLocalizationMode && !bLocalizationMode) {
      mpSystem->ActivateLocalizationMode(); // System��ü�� ����
                                            // mbActivateLocalizationMode ����
                                            // true�� ������
      bLocalizationMode = true; // Localization������� ������
    } else if (!menuLocalizationMode && bLocalizationMode) {
      mpSystem->DeactivateLocalizationMode(); //  System��ü�� ����
                                              //  mbDeactivateLocalizationMode
                                              //  ���� true�� ������
      bLocalizationMode = false; // LocalizationMode��尡 �ƴ��� ������
    }
    ...
    if (menuReset) {
      ...
      // bLocalizationMode = false; // original code

      // reset�� ����Ǵ� ���� �� ���� ������ �����Ѵ�.
      bLocalizationMode = mbReuseMap;
