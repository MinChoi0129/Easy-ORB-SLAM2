...
private:
  ...
  void fill_M(cv::Mat &M, const int row, const double *alphas, const double u,
              const double v);
  ...
  void find_betas_approx_1(const cv::Mat &L_6x10, const cv::Mat &Rho,
                           double *betas);
  void find_betas_approx_2(const cv::Mat &L_6x10, const cv::Mat &Rho,
                           double *betas);
  void find_betas_approx_3(const cv::Mat &L_6x10, const cv::Mat &Rho,
                           double *betas);
  ...
  void gauss_newton(const cv::Mat &L_6x10, const cv::Mat &Rho,
